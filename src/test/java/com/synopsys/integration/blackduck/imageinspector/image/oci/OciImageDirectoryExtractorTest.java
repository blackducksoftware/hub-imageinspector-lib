...
public class OciImageDirectoryExtractorTest {
    ...
    //TODO- add tests for multi-layer images (centos image)

    @Test
    public void testParseLayerArchives() throws IOException{
    ...
    @Test
    public void testGetLayerMapping() throws IntegrationException {
        CommonImageConfigParser configParser = new CommonImageConfigParser(new Gson());
        OciImageDirectoryExtractor extractor = new OciImageDirectoryExtractor(new Gson(), new FileOperations(), configParser);
        File alpineOciImageDir = new File(OCI_ALPINE_IMAGE_RESOURCE_PATH);
        ...
        Assertions.assertEquals("blobs/sha256/cdce9ebeb6e8364afeac430fe7a886ca89a90a5139bc3b6f40b5dbd0cf66391c", manifestLayerMapping.getPathToImageConfigFileFromRoot());
